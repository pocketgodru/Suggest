...
<a name="необходимые-файлы-и-их-установка"></a>
...
- `model_cache/` - кэш модели машинного обучения
...
1. **Скачать готовые файлы:**
   ...
   - После загрузки разместите файлы в следующих директориях:
     ...
     - Распакуйте `model_cache.zip` в корневую директорию проекта
...
- **Дисковое пространство:** не менее 8 ГБ свободного места
...
5. После успешного запуска откройте веб-интерфейс:
```
http://localhost:5003
```
