...
9. [Планируемые улучшения](#планируемые-улучшения)
...
### Генерация файлов с помощью парсера

Вместо скачивания готовых файлов можно сгенерировать их самостоятельно с помощью парсера Кинопоиска. Процесс занимает 15-50 минут в зависимости от мощности вашего компьютера:
...
2. Не менее 4 ГБ свободной оперативной памяти
3. Не менее 2 ГБ свободного места на диске
